...
Boid.prototype.separate = function(boids) {
    ...
    let desiredseparation = 25.0; // séparation de chaque éléments
...
Obstacle.prototype.render = function() {
    ...
    rect(this.center.x - this.shapeWidth/2, this.center.y - this.shapeHeight/2, this.shapeWidth, this.shapeHeight);
    ...
    // situation d'attraction
      ...
      if (
            ...
            ((// si le boid est situé sur la zone de bord gauche
                ...
                boid.location.x < (this.center.x - this.shapeWidth/2 + border))
          ...
          ||
            ...
            ((// si le boid est situé sur la zone de bord haute
                boid.location.y > (this.center.y - this.shapeHeight/2) &&
                boid.location.y < (this.center.y - this.shapeHeight/2 + border))
      ...
      if (boid.location.x < (this.center.x - this.shapeWidth/2 + border) ||
          boid.location.x > (this.center.x + this.shapeWidth/2 - border) ||
          boid.location.y < (this.center.y - this.shapeHeight/2 + border) ||
          boid.location.y > (this.center.y + this.shapeHeight/2 - border))
        {
